...
import com.plainid.assignment.converter.mapper.TrainerSetExtractor;
...
public class TrainerDAO implements IDAO<Trainer, String> {
    ...
    public Trainer get(String name) {
        ...
        return jdbcTemplate.query(sql, preparedStatement -> preparedStatement.setString(1, name), new TrainerSetExtractor()).get(0);
    }
    ...
    public List<Trainer> getAll() {
        ...
        return jdbcTemplate.query(sql, new TrainerSetExtractor());
    }
    ...
    public void delete(Trainer trainer) {
        jdbcTemplate.update("DELETE FROM TRAINER WHERE TID =" + trainer.getId());
    }
}
